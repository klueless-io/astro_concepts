KManager.action :bootstrap do
  action do
    application_name = :astro_concepts
    ...
    director = KDirector::Dsls::RubyGemDsl
      ...
      .data(
        ...
        application_description:    'astro_concepts is set of ruby functions testing code concepts that will be converted to TypeScript use in Astro Projects',
        application_lib_path:       application_name.to_s,
        application_lib_namespace:  'AstroConcepts',
        namespaces:                 ['AstroConcepts'],
        author:                     'David Cruwys',
        author_email:               'david@ideasmen.com.au',
        initial_semver:             '0.0.1',
        main_story:                 'As a Developer, I want to write first in Ruby and then convert to TypeScript, so that I can understand the process more completley',
        copyright_date:             '2022',
        website:                    'http://appydave.com/gems/astro_concepts'
      )
      .github(
        active: false,
...
KManager.opts.app_name                    = 'astro_concepts'
